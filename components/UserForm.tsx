...
import projectLogo from '../public/images/ca-logo.png';
...
const UserForm = () => {
    ...
    return (
        <Form onSubmit={handleSubmit}>
            {errorMessage && <Alert headingLevel="h3" type="error">{errorMessage}</Alert>}
            {successMessage && <Alert headingLevel="h3" type="success">{successMessage}</Alert>}
